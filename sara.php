...
<div class="products-title">
    ...
    <h1 class="product-name">Sara Screen</h1>

    <div class="product-container">
        <img src="products/Sara Screen/Sara Screen.PNG" alt="" class="prod-img">  
        <div class="color-container">
            <h1 class="color-name">Available Colors</h1>

            <div class="row1">
                <img src="products/Sara Screen/Beige.PNG" alt="" class="row1-img"> 
                <img src="products/Sara Screen/Forest.PNG" alt="" class="row1-img"> 
                <img src="products/Sara Screen/Khaki.PNG" alt="" class="row1-img"> 
            </div>
