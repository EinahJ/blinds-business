...
<div class="products-title">
    ...
    <div class="product-container">
        <img src="products/Vega/Vega.PNG" alt="" class="prod-img"> 
        <div class="color-container">
            <h1 class="color-name">Available Colors</h1>

            <div class="row1">
                <img src="products/Vega/Beige.PNG" alt="" class="row1-img"> 
                <img src="products/Vega/White.PNG" alt="" class="row1-img"> 
                <img src="products/Vega/Dark Brown.PNG" alt="" class="row1-img"> 
            </div>

            <div class="row2">
                <img src="products/Vega/Green.PNG" alt="" class="row1-img"> 
                <img src="products/Vega/Gray.PNG" alt="" class="row1-img"> 
            </div>
