...
<div class="products-title">
    ...
    <h1 class="product-name">Elegancy</h1>

    <div class="product-container">
        <img src="products/Elegancy/Elegancy.PNG" alt="" class="prod-img">  
        <div class="color-container">
            <h1 class="color-name">Available Colors</h1>

            <div class="row1">
                <img src="products/Elegancy/Beige.PNG" alt="" class="row1-img"> 
                <img src="products/Elegancy/Dark Brown.PNG" alt="" class="row1-img"> 
                <img src="products/Elegancy/Dark Gray.PNG" alt="" class="row1-img"> 
            </div>

            <div class="row2">
                <img src="products/Elegancy/Green.PNG" alt="" class="row1-img"> 
                <img src="products/Elegancy/Ivory.PNG" alt="" class="row1-img"> 
                <img src="products/Elegancy/Light Brown.PNG" alt="" class="row1-img"> 
            </div>
