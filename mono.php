...
<div class="products-title">
    ...
    <h1 class="product-name">Mono</h1>

    <div class="product-container">
        <img src="products/Mono/Mono.PNG" alt="" class="prod-img"> 
        <div class="color-container">
            <h1 class="color-name">Available Colors</h1>

            <div class="row1">
                <img src="products/Mono/Beige.PNG" alt="" class="row1-img"> 
                <img src="products/Mono/Blue.PNG" alt="" class="row1-img"> 
                <img src="products/Mono/Brown.PNG" alt="" class="row1-img"> 
            </div>

            <div class="row2">
                <img src="products/Mono/Choco.PNG" alt="" class="row1-img"> 
                <img src="products/Mono/Gray.PNG" alt="" class="row1-img"> 
            </div>
