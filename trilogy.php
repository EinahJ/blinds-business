...
<div class="products-title">
    ...
    <h1 class="product-name">Trilogy</h1>

<div class="product-container">
    <img src="products/Trilogy/Trilogy.PNG" alt="" class="prod-img">  
    <div class="color-container">
        <h1 class="color-name">Available Colors</h1>

        <div class="row1">
            <img src="products/Trilogy/Black.PNG" alt="" class="row1-img"> 
            <img src="products/Trilogy/Blue.PNG" alt="" class="row1-img"> 
            <img src="products/Trilogy/Brown.PNG" alt="" class="row1-img"> 
        </div>

        <div class="row2">
            <img src="products/Trilogy/Choco.PNG" alt="" class="row1-img"> 
            <img src="products/Trilogy/Gray.PNG" alt="" class="row1-img"> 
            <img src="products/Trilogy/Green.PNG" alt="" class="row1-img"> 
        </div>
